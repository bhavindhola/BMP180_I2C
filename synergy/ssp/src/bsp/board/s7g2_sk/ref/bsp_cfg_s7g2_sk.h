 ...
 * @defgroup BSP_CONFIG_S7G2SK_GENERAL Build Time Configurations - General
 *
 ...
 * This macro does not actually change anything on the MCU. Some modules need this information so it is
 * defined here.
 */
...
/** By default SSP modules will check input parameters to be valid. This is helpful during development but some users
...
/** @} (end of defgroup BSP_CONFIG_S7G2SK_GENERAL) */
